      ...
      <ul className='w-[1200px] flex items-center justify-between my-[138px]'>
        <li className='item w-[45%] h-[250px] bg-[#FBFBFB] flex justify-end pr-[30px] py-[40px] relative'>
          ...
          <div className='text-right flex flex-col gap-[20px] w-[290px] relative'>
            ...
            <Button extraClass='w-[140px] absolute bottom-0 right-0' type='button' rightIcon={<RightArrowIcon />} title='Find More' />
          </div>
        </li>
      ...
      <div>
        ...
        <ul className='flex gap-[44px]'>
          <li className='w-[268px] hover:scale-[1.1] duration-300'>
            <Image className='cursor-pointer'  src={'/images/blogItemImg1.png'} alt='blogItemImg1' width={268} height={195} priority/>
          ...
          <li className='w-[268px] hover:scale-[1.1] duration-300'>
            <Image className='cursor-pointer'  src={'/images/blogItemImg2.png'} alt='blogItemImg2' width={268} height={195} priority/>
            <div className='p-[12px] bg-[#FBFBFB] group'>
          ...
          <li className='w-[268px] hover:scale-[1.1] duration-300'>
            <Image className='cursor-pointer'  src={'/images/blogItemImg3.png'} alt='blogItemImg2' width={268} height={195} priority/>
            <div className='p-[12px] bg-[#FBFBFB] group'>
          ...
          <li className='w-[268px] hover:scale-[1.1] duration-300'>
            <Image className='cursor-pointer'  src={'/images/blogItemImg4.png'} alt='blogItemImg' width={268} height={195} priority/>
            <div className='p-[12px] bg-[#FBFBFB] group'>
